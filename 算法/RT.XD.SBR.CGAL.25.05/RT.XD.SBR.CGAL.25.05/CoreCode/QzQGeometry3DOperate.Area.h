...
namespace Geometry3DOperateStd {
    ...
    INTERFACE_API double AreaCalculateOfTriangle3D_plus(const Point3DStd::Point3D& p1, const Point3DStd::Point3D& p2, const Point3DStd::Point3D& p3);
    INTERFACE_API double AreaCalculateOfTriangle3D(const Triangle3DStd::Triangle3D& triangle);
