...
namespace Geometry3DOperateStd {
    INTERFACE_API int Set_Contain_Point3DInVectorPoint3D_Absolute(const Point3DStd::Point3D& value, const std::vector<Point3DStd::Point3D>& list);
    INTERFACE_API int Set_Contain_Point3DInVectorPoint3D(const Point3DStd::Point3D& value, const std::vector<Point3DStd::Point3D>& list);
}