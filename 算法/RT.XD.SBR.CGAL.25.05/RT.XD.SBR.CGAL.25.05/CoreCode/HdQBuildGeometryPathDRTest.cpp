...
#include"HdQBuildGeometryPathDRTest.h"
...
namespace BuildGeometryPathDRTestStd {
	...
	void Demo01() {
		...
		//假设碰撞点依次为（-1，1，0） (0，0，0) （1，1，0）（0，2，0），通过
		...
		geometryPathDRInputParameter.tx_location.x = -2;
		geometryPathDRInputParameter.tx_location.y = 2;
		geometryPathDRInputParameter.tx_location.z = 0;

		geometryPathDRInputParameter.rx_location.x = 0;
		...
		BuildGeometryPathDRStd::BuildGeometryPathDR(numbersOfGuess, maxLevel, geometryPathDRInputParameter, paths);
