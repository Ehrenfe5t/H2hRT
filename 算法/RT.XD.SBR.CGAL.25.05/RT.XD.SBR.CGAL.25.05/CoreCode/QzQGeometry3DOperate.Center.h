...
namespace Geometry3DOperateStd {
    ...
    INTERFACE_API Point3DStd::Point3D Center_Point3D_Point3D(const Point3DStd::Point3D& p1, const Point3DStd::Point3D& p2);
    INTERFACE_API Point3DStd::Point3D Center_Point3D_Point3D_Point3D(const Point3DStd::Point3D& p1, const Point3DStd::Point3D& p2, const Point3DStd::Point3D& p3);
