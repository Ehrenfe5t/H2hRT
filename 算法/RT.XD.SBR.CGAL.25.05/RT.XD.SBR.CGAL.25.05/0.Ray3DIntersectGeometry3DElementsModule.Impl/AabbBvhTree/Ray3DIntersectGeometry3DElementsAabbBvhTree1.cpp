...
namespace Ray3DIntersectGeometry3DElementsAabbBvhTree1Std {
...
namespace Ray3DIntersectGeometry3DElementsAabbBvhTree1Std {
	...
	void Ray3DIntersectAabbBvhTreeTriangle3D2(
		...
		std::unordered_set<int>& triangleIndices) {

		if (!root) {
			return;
		}

		bool isIntersect = Ray3DIntersectAabb(ray_origin, ray_direction, root->Bound);
		if (!isIntersect) {
			return;
		}
...
namespace Ray3DIntersectGeometry3DElementsAabbBvhTree1Std {
	...
	void CalculateRay3DIntersectTriangle3DAabbBvhTreeFirst(
		...
		//std::unordered_set<int> unordered_triangleIndices;
		//Ray3DIntersectAabbBvhTreeTriangle3D2(ray_origin, ray_direction, RootAabbBvhTree, unordered_triangleIndices);
		//// 高效转换：通过迭代器范围构造
		//std::set<int> triangleIndices(unordered_triangleIndices.begin(), unordered_triangleIndices.end());
		//
