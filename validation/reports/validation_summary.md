...
**Timestamp**: 2026-06-29T19:37:30.037471
**Backend**: cpu
...
| G-3 | RT | PASS | OK: paths=1 |
| G-4 | RT | PASS | OK: paths=1 |
| G-5-prod | RT | PASS | OK: paths=142 tx=24 diff=84 |
| G-6 | RT | PASS | OK: paths=1 diff=1 |
| G-TK | RT | PASS | paths=1 unique=1 refined=1 |
| EM-1 | ANA | PASS | E+(-E)=0 |
...
| SBR-1 | RT | PASS | pwr=0.06uW paths=142 |
